Feature: Read Booking IDs
  ...
  Scenario: Query a specific booking with a first and last name
...
Scenario: Query a specific booking with a first name
    Given the user creates a booking under my name
    When the user enters "get ids"
    And the user enters "Zach"
  ...
  Scenario: Queries a specific booking with a checkout date
    Given the user creates a booking under my name
    When the user enters "get ids"
    When the user enters nothing for "2" other inputs
  ...
  Scenario: Queries a specific booking with all arguments
    Given the user creates a booking under my name
    When the user enters "get ids"
    And the user enters "Zach"
    And the user enters "Schwartz"
